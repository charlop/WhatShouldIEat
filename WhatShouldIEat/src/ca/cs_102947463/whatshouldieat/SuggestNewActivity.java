...
public class SuggestNewActivity extends Activity implements View.OnClickListener {
	public static final String SUGGEST_NEW_URL = "http://charlop.myweb.cs.uwindsor.ca/420/suggest_new.html";
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
        ...
        Fragment fragment = new SuggestNewFragment();
   ...
   public class SuggestNewFragment extends Fragment 
   {
	   public SuggestNewFragment() {}
	   ...
	   public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	   {
		   ...
		   mWebView.loadUrl(SUGGEST_NEW_URL);
		   return mWebView;
	   }
